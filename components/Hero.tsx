...
const Hero = () => {
  return (
    <section className="min-h-[80vh] flex flex-col  justify-center text-center">
        <h1 className="text-5xl md:text-7xl font-bold mb-4 ">Kevin Njuguna</h1>
        <h2 className="text-gray-400 text-2xl mb-6 font-bold">Full Stack Software Engineer</h2>
        <p className="text-gray-500  mb-12 font-semibold">
            I build scalable web applications and backend systems with modern technologies.
        </p>
        ...
        <p className="text-gray-500 font-semibold text-[.7rem]  group-hover:text-green-500">VIEW MY WORK</p>
